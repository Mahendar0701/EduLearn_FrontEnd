...
//     // Mock useCourseDetailsState and useModuleState to return mock data
//     useCourseDetailsState.mockReturnValue(mockCourseDetailsState);
//     useModuleState.mockReturnValue(mockModuleState);
